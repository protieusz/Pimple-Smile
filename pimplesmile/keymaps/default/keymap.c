...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN1] = LAYOUT(
        ...
        KC_TAB,  SCRL_MO, KC_MUTE, KC_VOLD, KC_VOLU,                           KC_MINS,  KC_EQL,  KC_LBRC, KC_RBRC, KC_QUOT,
        _______, _______, _______, KC_MS_BTN2, KC_MS_BTN1,                     KC_TILD,  KC_GRV,  _______, _______, KC_BSLS,
